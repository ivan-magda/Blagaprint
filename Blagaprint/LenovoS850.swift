...
class LenovoS850 : NSObject {
    ...
    class func drawLenovoS(frame: CGRect, colorOfText: UIColor, fillColor: UIColor, image: UIImage, textYscale: CGFloat, caseText: String, textRectHeight: CGFloat, var textSize: CGFloat, textXscale: CGFloat, backgroundImageVisible: Bool) {
        ...
        //// Image Declarations
        let lenovoS850CameraImage = UIImage(named: "lenovoS850CameraImage.png")
    ...
    class func imageOfLenovoS(frame: CGRect, colorOfText: UIColor, fillColor: UIColor, image: UIImage, textYscale: CGFloat, caseText: String, textRectHeight: CGFloat, textSize: CGFloat, textXscale: CGFloat, backgroundImageVisible: Bool) -> UIImage {
        ...
        let imageOfLenovoS = UIGraphicsGetImageFromCurrentImageContext()
