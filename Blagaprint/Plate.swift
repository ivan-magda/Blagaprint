...
public class Plate : NSObject {
    ...
    public class func drawPlateCanvas(frame frame: CGRect = CGRectMake(0, 0, 320, 320), image: UIImage = UIImage(), isPlateImageVisible: Bool = true) {
    ...
    public class func imageOfPlateCanvas(frame frame: CGRect = CGRectMake(0, 0, 320, 320), image: UIImage = UIImage(), isPlateImageVisible: Bool = true) -> UIImage {
