...
class CaseView: UIView {
    ...
    override func drawRect(rect: CGRect) {
        ...
        if device.name == Device.iPhone4().name {
            ...
            LenovoS850.drawLenovoS(self.bounds, colorOfText: textColor, fillColor: fillColor, image: image, textYscale: textYscale, caseText: text, textRectHeight: textRectHeight, textSize: textSize, textXscale: textXscale, backgroundImageVisible: showBackgroundImage)
        }
    }
        ...
        if device.name == Device.iPhone5().name {
            ...
            default:
                return 39.0
                  ...
                  device.name == Device.lenovoS850().name {
            switch characters {
            case 1, 2:
                return 225.0
            case 3:
