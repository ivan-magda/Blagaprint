...
class GalaxyNote2 : NSObject {
    ...
    class func drawGalaxyNote2(frame: CGRect, colorOfText: UIColor, fillColor: UIColor, image: UIImage, var textSize: CGFloat, textXscale: CGFloat, textRectHeight: CGFloat, caseText: String, textYscale: CGFloat, backgroundImageVisible: Bool) {
        ...
        //// Image Declarations
        let galaxyNote2CameraImage = UIImage(named: "galaxyNote2CameraImage.png")
        let galaxyNote2Speaker = UIImage(named: "galaxyNote2Speaker.png")
        ...
        //// Text Drawing
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, frame.minX + 15, frame.minY + 85)
        ...
        bezierPath.addCurveToPoint(CGPointMake(frame.minX + 198.47, frame.minY + 35.08), controlPoint1: CGPointMake(frame.minX + 178.5, frame.minY + 31.51), controlPoint2: CGPointMake(frame.minX + 191.82, frame.minY + 31))
        bezierPath.addCurveToPoint(CGPointMake(frame.minX + 210.17, frame.minY + 45.27), controlPoint1: CGPointMake(frame.minX + 205.12, frame.minY + 39.15), controlPoint2: CGPointMake(frame.minX + 206.27, frame.minY + 40.17))
        bezierPath.addCurveToPoint(CGPointMake(frame.minX + 216.5, frame.minY + 60.04), controlPoint1: CGPointMake(frame.minX + 214.06, frame.minY + 50.36), controlPoint2: CGPointMake(frame.minX + 216.5, frame.minY + 60.04))
        bezierPath.addLineToPoint(CGPointMake(frame.minX + 216.5, frame.minY + 386.11))
        bezierPath.addCurveToPoint(CGPointMake(frame.minX + 178.99, frame.minY + 407), controlPoint1: CGPointMake(frame.minX + 216.5, frame.minY + 386.11), controlPoint2: CGPointMake(frame.minX + 216.01, frame.minY + 407))
        bezierPath.addCurveToPoint(CGPointMake(frame.minX + 159.5, frame.minY + 407), controlPoint1: CGPointMake(frame.minX + 141.96, frame.minY + 407), controlPoint2: CGPointMake(frame.minX + 159.5, frame.minY + 407))
        bezierPath.addLineToPoint(CGPointMake(frame.minX + 81.55, frame.minY + 407))
        bezierPath.addCurveToPoint(CGPointMake(frame.minX + 62.06, frame.minY + 407), controlPoint1: CGPointMake(frame.minX + 81.55, frame.minY + 407), controlPoint2: CGPointMake(frame.minX + 94.13, frame.minY + 407))
        bezierPath.addCurveToPoint(CGPointMake(frame.minX + 26, frame.minY + 377.45), controlPoint1: CGPointMake(frame.minX + 30, frame.minY + 407), controlPoint2: CGPointMake(frame.minX + 26, frame.minY + 384.58))
        bezierPath.addCurveToPoint(CGPointMake(frame.minX + 26.5, frame.minY + 60.04), controlPoint1: CGPointMake(frame.minX + 26, frame.minY + 370.32), controlPoint2: CGPointMake(frame.minX + 26.5, frame.minY + 60.04))
        bezierPath.addCurveToPoint(CGPointMake(frame.minX + 29.91, frame.minY + 45.27), controlPoint1: CGPointMake(frame.minX + 26.5, frame.minY + 60.04), controlPoint2: CGPointMake(frame.minX + 26.01, frame.minY + 52.4))
        bezierPath.addCurveToPoint(CGPointMake(frame.minX + 53.29, frame.minY + 31), controlPoint1: CGPointMake(frame.minX + 31.45, frame.minY + 42.44), controlPoint2: CGPointMake(frame.minX + 36.73, frame.minY + 35.08))
        caseStrokeColor.setStroke()
    ...
    class func imageOfGalaxyNote2(frame: CGRect, colorOfText: UIColor, fillColor: UIColor, image: UIImage, textSize: CGFloat, textXscale: CGFloat, textRectHeight: CGFloat, caseText: String, textYscale: CGFloat, backgroundImageVisible: Bool) -> UIImage {
        ...
        let imageOfGalaxyNote2 = UIGraphicsGetImageFromCurrentImageContext()
