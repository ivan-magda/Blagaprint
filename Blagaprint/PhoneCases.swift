...
class PhoneCases : NSObject {
    ...
    class func drawIPhoneCase(frame: CGRect, fillColor: UIColor, colorOfText: UIColor, caseText: String) {
        ...
        rectanglePath.addCurveToPoint(CGPointMake(frame.maxX - 20.5, frame.maxY - 60.5), controlPoint1: CGPointMake(frame.minX + 197.76, frame.minY + 356), controlPoint2: CGPointMake(frame.maxX - 20.5, frame.maxY - 60.5))
        rectanglePath.addCurveToPoint(CGPointMake(frame.maxX - 20.5, frame.minY + 60), controlPoint1: CGPointMake(frame.maxX - 20.5, frame.maxY - 60.5), controlPoint2: CGPointMake(frame.maxX - 20.5, frame.minY + 71.5))
