...
//  PhoneCases
//
//  Created by Ivan Magda on 15.10.15.
...
class PhoneCases : NSObject {
    ...
    class func drawIPhoneCase(frame: CGRect, fillColor: UIColor, colorOfText: UIColor, image: UIImage, caseText: String, backgroundImageVisible: Bool) {
        ...
        if (backgroundImageVisible) {
            ...
            CGContextSetAlpha(context, CGColorGetAlpha(PhoneCases.innerShadow.shadowColor!.CGColor))
            CGContextBeginTransparencyLayer(context, nil)
            let backgroundImageRectangleOpaqueShadow = PhoneCases.innerShadow.shadowColor!.colorWithAlphaComponent(1)
            CGContextSetShadowWithColor(context, PhoneCases.innerShadow.shadowOffset, PhoneCases.innerShadow.shadowBlurRadius, backgroundImageRectangleOpaqueShadow.CGColor)
            CGContextSetBlendMode(context, .SourceOut)
            CGContextBeginTransparencyLayer(context, nil)
    ...
    class func imageOfIPhoneCase(frame: CGRect, fillColor: UIColor, colorOfText: UIColor, image: UIImage, caseText: String, backgroundImageVisible: Bool) -> UIImage {
        ...
        PhoneCases.drawIPhoneCase(frame, fillColor: fillColor, colorOfText: colorOfText, image: image, caseText: caseText, backgroundImageVisible: backgroundImageVisible)
        var imageOfIPhoneCase = UIGraphicsGetImageFromCurrentImageContext()
