...
public class BusinessCard : NSObject {
    ...
    public class func drawBusinessCardCanvas(frame frame: CGRect = CGRectMake(0, 0, 320, 180), image: UIImage = UIImage(), imageVisible: Bool = false) {
    ...
    public class func imageOfBusinessCardCanvas(frame frame: CGRect = CGRectMake(0, 0, 320, 180), image: UIImage = UIImage(), imageVisible: Bool = false) -> UIImage {
