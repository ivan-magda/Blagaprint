...
class GalaxyA7 : NSObject {
    ...
    class func drawGalaxyA7Canvas(frame: CGRect, fillColor: UIColor, colorOfText: UIColor, image: UIImage, textXscale: CGFloat, var textSize: CGFloat, backgroundImageVisible: Bool, caseText: String, textYscale: CGFloat, textRectHeight: CGFloat) {
        ...
        //// Image Declarations
        let galaxyA7Led = UIImage(named: "galaxyA7Led.png")
        let galaxyA7Speaker = UIImage(named: "galaxyA7Speaker.png")
        let galaxyA7CameraImage = UIImage(named: "galaxyA7CameraImage.png")
        ...
        let textRect: CGRect = CGRectMake(0, textYoffset, 265, textRectHeight)
    ...
    class func imageOfGalaxyA7Canvas(frame: CGRect, fillColor: UIColor, colorOfText: UIColor, image: UIImage, textXscale: CGFloat, textSize: CGFloat, backgroundImageVisible: Bool, caseText: String, textYscale: CGFloat, textRectHeight: CGFloat) -> UIImage {
        ...
        let imageOfGalaxyA7Canvas = UIGraphicsGetImageFromCurrentImageContext()
