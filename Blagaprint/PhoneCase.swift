...
//  PhoneCases
//
//  Created by Ivan Magda on 20.10.15.
...
class PhoneCase : NSObject {
    ...
    class func drawIPhoneCase(frame: CGRect, fillColor: UIColor, colorOfText: UIColor, image: UIImage, caseText: String, backgroundImageVisible: Bool) {
        ...
        let characters = caseText.characters.count
        let textRectHeight = IPhoneCase.getTextRectHeightFromNumberOfCharacters(characters)
        let textYoffset = -textRectHeight
        let textYscale = IPhoneCase.getTextYscaleFromNumberOfCharacters(characters)
        let textFontSize = IPhoneCase.getTextFontSizeFromNumberOfCharacters(characters)

        //// Rectangle Drawing
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, frame.minX + 111.01, frame.minY + 198.64)
        ...
        //// Text Drawing
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, frame.minX + 21, frame.minY + 60)
        ...
        let textFontAttributes = [NSFontAttributeName: UIFont(name: "Helvetica", size: textFontSize)!, NSForegroundColorAttributeName: colorOfText, NSParagraphStyleAttributeName: textStyle]
