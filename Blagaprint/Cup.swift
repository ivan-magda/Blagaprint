...
public class Cup : NSObject {
    ...
    public class func drawCupFront(frame frame: CGRect = CGRectMake(10, 15, 320, 320), pickedImage: UIImage = UIImage(), imageVisible: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
    ...
    public class func imageOfCupLeft(frame frame: CGRect = CGRectMake(10, 15, 320, 320), pickedImage: UIImage = UIImage(), imageVisible: Bool = false) -> UIImage {
    ...
    public class func imageOfCupRight(frame frame: CGRect = CGRectMake(10, 15, 320, 320), pickedImage: UIImage = UIImage(), imageVisible: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
    ...
    public class func imageOfCupFront(frame frame: CGRect = CGRectMake(0, 0, 320, 320), pickedImage: UIImage = UIImage(), imageVisible: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
