...
public class Cup : NSObject {
    ...
    public class func drawCupLeft(frame frame: CGRect = CGRectMake(10, 15, 320, 320), pickedImage: UIImage = UIImage(), imageVisible: Bool = false) {
    ...
    public class func drawCupRight(frame frame: CGRect = CGRectMake(10, 15, 320, 320), pickedImage: UIImage = UIImage(), imageVisible: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
