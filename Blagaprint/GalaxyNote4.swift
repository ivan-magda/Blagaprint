...
class GalaxyNote4 : NSObject {
    ...
    class func drawNote4(frame: CGRect, colorOfText: UIColor, fillColor: UIColor, image: UIImage, caseText: String, textYscale: CGFloat, backgroundImageVisible: Bool, textXscale: CGFloat, var textSize: CGFloat, textRectHeight: CGFloat) {
        ...
        //// Image Declarations
        let galaxyNote4Speaker = UIImage(named: "galaxyNote4Speaker.png")
        let galaxyNote4CameraImage = UIImage(named: "galaxyNote4CameraImage.png")
    ...
    class func imageOfNote4(frame: CGRect, colorOfText: UIColor, fillColor: UIColor, image: UIImage, caseText: String, textYscale: CGFloat, backgroundImageVisible: Bool, textXscale: CGFloat, textSize: CGFloat, textRectHeight: CGFloat) -> UIImage {
        ...
        let imageOfNote4 = UIGraphicsGetImageFromCurrentImageContext()
