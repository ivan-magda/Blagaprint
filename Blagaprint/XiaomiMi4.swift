...
class XiaomiMi4 : NSObject {
    ...
    class func drawXiaomiMi(frame: CGRect, fillColor: UIColor, colorOfText: UIColor, image: UIImage, textYscale: CGFloat, textXscale: CGFloat, var textSize: CGFloat, textRectHeight: CGFloat, backgroundImageVisible: Bool, caseText: String) {
        ...
        //// Image Declarations
        let xiaomiMi4CameraImage = UIImage(named: "xiaomiMi4CameraImage.png")
        let xiaomiMi4Microphone = UIImage(named: "xiaomiMi4Microphone.png")
        ...
        let microphonePath = UIBezierPath(ovalInRect: microphoneRect)
        CGContextSaveGState(context)
        CGContextSetShadowWithColor(context, XiaomiMi4.outerShadow.shadowOffset, XiaomiMi4.outerShadow.shadowBlurRadius, XiaomiMi4.outerShadow.shadowColor!.CGColor)
        CGContextBeginTransparencyLayer(context, nil)
        CGContextSaveGState(context)
    ...
    class func imageOfXiaomiMi(frame: CGRect, fillColor: UIColor, colorOfText: UIColor, image: UIImage, textYscale: CGFloat, textXscale: CGFloat, textSize: CGFloat, textRectHeight: CGFloat, backgroundImageVisible: Bool, caseText: String) -> UIImage {
        ...
        let imageOfXiaomiMi = UIGraphicsGetImageFromCurrentImageContext()
